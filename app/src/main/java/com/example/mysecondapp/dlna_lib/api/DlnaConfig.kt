 ...
 * @property serverUdn A unique identifier (UUID) for this server. MUST persist across restarts.
...
data class DlnaConfig(
    ...
    val serverUdn: String, // CHANGE: Added to prevent "new device" detection on restart
